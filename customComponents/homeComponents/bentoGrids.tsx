  ...
  return (
    <div className="min-h-[80vh] h-full w-full grid xl:grid-cols-2 grid-cols-1 gap-5 overflow-hidden">
      <SlideComponent dir="left">
        <div className="dotbg w-full h-full xl:min-h-full min-h-[300px] bg-grayblack relative aspect-auto lg:aspect-video  text-graywhite overflow-hidden  rounded-2xl md:p-8 p-4 flex flex-col gap-3">
      ...
      <div className="w-full h-full grid md:grid-cols-2 grid-cols-1 gap-5 min-h-full">
        <SlideComponent className="col-span-2 w-full" dir="down">
          <div className="w-full h-full xl:min-h-full min-h-[300px] dotbg bg-[#D7D8DC] text-grayblack rounded-2xl flex flex-col justify-between md:p-8 p-4 gap-3 overflow-hidden">
            <div className="w-full flex flex-row justify-between items-center">
              <h3 className="md:text-lg text-base uppercase animate-slideInDown ">
                {t("world_of_hearing")}
              </h3>
              <Link href={"/blogs"} className="hover:scale-150 duration-500">
        ...
        <SlideComponent
          ...
          dir="left"
        >
          <div className="w-full h-full bg-[#D7D8DC] dotbg text-grayblack rounded-2xl flex flex-col justify-between md:p-8 p-4 gap-3 overflow-hidden">
            <div className="w-full flex flex-row justify-between items-center">
        ...
        <SlideComponent
          ...
          dir="right"
        >
          <div className="w-full h-full bg-grayblack text-graywhite rounded-2xl flex flex-col justify-between md:p-8 p-4 gap-3 relative overflow-hidden">
            <Image
              className="w-full h-full absolute object-cover top-0 bottom-0 left-0 right-0"
              alt="mission"
              src={bgUrl}
